...
<%}
	...
	{
		PreparedStatement ps1 = con.prepareStatement("select JOURNEY_DATE,FLIGHT_NUMBER,FLIGHT_NAME,CLASS,SOURCE,DESTINATION,BOARDINGTIME,FARETYPE from bookingdetails where BOOK_ID=?");
		...
		%>
		    <div class= main>
			    ...
			    <div class="flights"><%=rs1.getString(2)%>-<%=rs1.getString(3)%></div>
			    </div>
		...
		PreparedStatement ps = con.prepareStatement("select PASSENGER_NAME,AGE,GENDER from FLIGHTPASSENGERDETAILS where BOOK_ID=?");
