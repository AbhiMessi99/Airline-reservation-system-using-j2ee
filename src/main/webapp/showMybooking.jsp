...
<%}
	...
	{
		PreparedStatement ps = con.prepareStatement("select BOOK_ID,JOURNEY_DATE,FLIGHT_NUMBER,FLIGHT_NAME,PASSENGERS,CLASS,SOURCE,DESTINATION,BOARDINGTIME from bookingdetails where username=?");
		ps.setString(1,uid);
		...
		if(rs.next())
		{
			...
			<tr>
				...
				<%}%>
				<td>
				 <button onclick="sendData('<%=rs.getString(1) %>')" class="rounded-button">Show Details</button>
				</td>
				<td>
		    ...
		    <form id="form1" action="startCancellaton.jsp" method="post">
